...
public class SystemApiUtils {
    ...
    private static SystemApiUtils util;

    public static SystemApiUtils getInstance(Context context){
        if (util==null) {
            util=new SystemApiUtils(context);
        }
        return util;

    }

    private SystemApiUtils(Context context) {
        super();
    ...
    public boolean isMobileDataOn() {
        ...
        try {
            ...
            isOpen = (Boolean) method.invoke(connManager, new  Object[]{});
        } catch (Exception e) {
            e.printStackTrace();
        }
